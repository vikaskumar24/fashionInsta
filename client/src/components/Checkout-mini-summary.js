  ...
  <ListGroup>
    ...
    <ListGroupItem>
      <Row>
        ...
        <Col xs='4'><p>{selectorTotalAmountCart}Rs</p></Col>
      </Row>
      <Row>
        <Col xs='8'><p>Shipping</p></Col>
        <Col xs='4'><p>{totalDelivery}Rs</p></Col>
      </Row>
      <Row>
        <Col xs='8'><p>Tax</p></Col>
        <Col xs='4'><p>0 Rs</p></Col>
      </Row>
    </ListGroupItem>
    <ListGroupItem>
      <Row>
        <Col xs='8'><p>Total</p></Col>
        <Col xs='4'><b style={{fontSize: '25px'}}>{selectorTotalAmountCart+totalDelivery} Rs</b></Col>
      </Row>
    </ListGroupItem>
  </ListGroup>
);
