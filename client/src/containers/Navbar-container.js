    ...
    return (
      <div className="sticky-top">
        <Navbar light expand="md" style={navbarBackground}>
          <img src="/images/fashionn.jpg" alt="fashionista" className='img-fluid' style={{width:"90px", borderRadius:"15px"}} />
          <Link to="/" style={itemMenu} className="text-white ml-5"> Home</Link>
